...
$contato = 'A Rita da Marmita entrega<br>  WhatsApp 11 99192-9394 <img id="delivery" src="./img/icondelivery.png"/><br/> Rod. dos Imigrantes, 1 - Jabaquara, São Paulo - SP';
...
$items = array(
    ...
    Escolha o tamanho 
    <input value="P" type="radio" name="tamanho"/>P 
    <input value="M" type="radio" name="tamanho" /> M 
    <input value="G" type="radio" name="tamanho"/> G
    </span>', 
